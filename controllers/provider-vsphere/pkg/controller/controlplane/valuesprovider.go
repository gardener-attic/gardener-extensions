...
var controlPlaneShootChart = &chart.Chart{
	...
	SubCharts: []*chart.Chart{
		...
		},
		{
			...
			Objects: []*chart.Object{
				{Type: &corev1.Secret{}, Name: "csi-vsphere-config-secret"},
				{Type: &rbacv1.ClusterRole{}, Name: "garden.sapcloud.io:vsphere-csi-controller"},
				{Type: &rbacv1.ClusterRoleBinding{}, Name: "garden.sapcloud.io:vsphere-csi-controller"},
				{Type: &rbacv1.ClusterRole{}, Name: "garden.sapcloud.io:vsphere-csi-syncer"},
				{Type: &rbacv1.ClusterRoleBinding{}, Name: "garden.sapcloud.io:vsphere-csi-syncer"},
				{Type: &rbacv1.ClusterRole{}, Name: "garden.sapcloud.io:csi-attacher"},
				{Type: &rbacv1.ClusterRoleBinding{}, Name: "garden.sapcloud.io:csi-attacher"},
				{Type: &rbacv1.ClusterRole{}, Name: "garden.sapcloud.io:csi-provisioner"},
