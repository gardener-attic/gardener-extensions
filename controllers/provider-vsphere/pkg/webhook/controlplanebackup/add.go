...
import (
	...
	"github.com/gardener/gardener-extensions/controllers/provider-vsphere/pkg/imagevector"
...
// AddOptions are options to apply when adding the vSphere backup webhook to the manager.
type AddOptions struct {
	// ETCDBackup is the etcd backup configuration.
	ETCDBackup config.ETCDBackup
}

var logger = log.Log.WithName("vsphere-controlplanebackup-webhook")
