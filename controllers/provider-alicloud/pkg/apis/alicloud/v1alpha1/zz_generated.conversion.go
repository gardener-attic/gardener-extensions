...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProviderProfileConfig)(nil), (*alicloud.ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProviderProfileConfig_To_alicloud_ProviderProfileConfig(a.(*ProviderProfileConfig), b.(*alicloud.ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*alicloud.ProviderProfileConfig)(nil), (*ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_alicloud_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(a.(*alicloud.ProviderProfileConfig), b.(*ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ProviderProfileConfig_To_alicloud_ProviderProfileConfig(in *ProviderProfileConfig, out *alicloud.ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]alicloud.MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_v1alpha1_ProviderProfileConfig_To_alicloud_ProviderProfileConfig is an autogenerated conversion function.
func Convert_v1alpha1_ProviderProfileConfig_To_alicloud_ProviderProfileConfig(in *ProviderProfileConfig, out *alicloud.ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderProfileConfig_To_alicloud_ProviderProfileConfig(in, out, s)
}

func autoConvert_alicloud_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *alicloud.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_alicloud_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig is an autogenerated conversion function.
func Convert_alicloud_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *alicloud.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_alicloud_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in, out, s)
}
