...
func NewTerraformer(factory terraformer.Factory, config *rest.Config, credentials *client.Credentials, purpose, namespace, name string) (terraformer.Interface, error) {
