...
func RegisterHealthChecks(mgr manager.Manager, opts healthcheck.DefaultAddArgs) error {
	...
	if err := healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			general.CheckSeedDeployment(alicloud.CsiPluginController):                                    string(gardencorev1alpha1.ShootControlPlaneHealthy),
			general.CheckSeedDeployment(alicloud.CloudControllerManagerName):                             string(gardencorev1alpha1.ShootControlPlaneHealthy),
	...
	return healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			...
			general.CheckSeedDeployment(alicloud.MachineControllerManagerName):       string(gardencorev1alpha1.ShootEveryNodeReady),
