	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			reconcileOpts.Completed().Apply(
				&alicloudinfrastructure.DefaultAddOptions.IgnoreOperationAnnotation,
				&alicloudcontrolplane.DefaultAddOptions.IgnoreOperationAnnotation,
				&alicloudworker.DefaultAddOptions.IgnoreOperationAnnotation,
			)
