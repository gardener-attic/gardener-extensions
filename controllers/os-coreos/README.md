...
You can run the controller locally on your machine by executing `make start-os-coreos`. Please make sure to have the kubeconfig to the cluster you want to connect to ready in the `./dev/kubeconfig` file.
