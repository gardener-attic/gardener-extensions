...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProviderProfileConfig)(nil), (*packet.ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProviderProfileConfig_To_packet_ProviderProfileConfig(a.(*ProviderProfileConfig), b.(*packet.ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*packet.ProviderProfileConfig)(nil), (*ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_packet_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(a.(*packet.ProviderProfileConfig), b.(*ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ProviderProfileConfig_To_packet_ProviderProfileConfig(in *ProviderProfileConfig, out *packet.ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]packet.MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_v1alpha1_ProviderProfileConfig_To_packet_ProviderProfileConfig is an autogenerated conversion function.
func Convert_v1alpha1_ProviderProfileConfig_To_packet_ProviderProfileConfig(in *ProviderProfileConfig, out *packet.ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderProfileConfig_To_packet_ProviderProfileConfig(in, out, s)
}

func autoConvert_packet_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *packet.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_packet_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig is an autogenerated conversion function.
func Convert_packet_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *packet.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_packet_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in, out, s)
}
