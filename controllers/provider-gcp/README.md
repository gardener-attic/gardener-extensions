...
| --------------- | ----------- | ------------------------ |
| Kubernetes 1.16<sup>1</sup> | 1.16.0+      | [![Gardener v1.16 Conformance Tests](https://testgrid.k8s.io/q/summary/conformance-gardener/Gardener,%20v1.16%20GCE/tests_status?style=svg)](https://testgrid.k8s.io/conformance-gardener#Gardener,%20v1.16%20GCE) |
...
<sup>1</sup> v1.16 node port tests are currently failing because of hardened security, see [gardener/machine-controller-manager#339](https://github.com/gardener/machine-controller-manager/issues/339).
