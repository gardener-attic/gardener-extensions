...
func ValidateControlPlaneConfig(controlPlaneConfig *apisgcp.ControlPlaneConfig, region string, regions []gardencorev1alpha1.Region) field.ErrorList {
...
func ValidateControlPlaneConfigUpdate(oldConfig, newConfig *apisgcp.ControlPlaneConfig, region string, regions []gardencorev1alpha1.Region) field.ErrorList {
	allErrs := field.ErrorList{}
