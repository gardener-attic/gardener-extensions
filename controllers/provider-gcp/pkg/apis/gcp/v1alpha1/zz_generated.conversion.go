...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProviderProfileConfig)(nil), (*gcp.ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProviderProfileConfig_To_gcp_ProviderProfileConfig(a.(*ProviderProfileConfig), b.(*gcp.ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*gcp.ProviderProfileConfig)(nil), (*ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_gcp_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(a.(*gcp.ProviderProfileConfig), b.(*ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ProviderProfileConfig_To_gcp_ProviderProfileConfig(in *ProviderProfileConfig, out *gcp.ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]gcp.MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_v1alpha1_ProviderProfileConfig_To_gcp_ProviderProfileConfig is an autogenerated conversion function.
func Convert_v1alpha1_ProviderProfileConfig_To_gcp_ProviderProfileConfig(in *ProviderProfileConfig, out *gcp.ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderProfileConfig_To_gcp_ProviderProfileConfig(in, out, s)
}

func autoConvert_gcp_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *gcp.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	out.MachineImages = *(*[]MachineImages)(unsafe.Pointer(&in.MachineImages))
	return nil
}

// Convert_gcp_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig is an autogenerated conversion function.
func Convert_gcp_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *gcp.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_gcp_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in, out, s)
}
