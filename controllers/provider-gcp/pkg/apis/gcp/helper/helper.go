...
// returned.
func FindSubnetByPurpose(subnets []gcp.Subnet, purpose gcp.SubnetPurpose) (*gcp.Subnet, error) {
...
func FindMachineImage(machineImages []gcp.MachineImage, name, version string) (*gcp.MachineImage, error) {
