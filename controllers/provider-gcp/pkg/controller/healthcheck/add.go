...
func RegisterHealthChecks(mgr manager.Manager, opts healthcheck.DefaultAddArgs) error {
	...
	if err := healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			general.CheckSeedDeployment(gcp.CloudControllerManagerName):                                  string(gardencorev1alpha1.ShootControlPlaneHealthy),
	...
	return healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			...
			general.CheckSeedDeployment(gcp.MachineControllerManagerName):            string(gardencorev1alpha1.ShootEveryNodeReady),
