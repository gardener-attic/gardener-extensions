...
func decodeWorkerConfig(decoder runtime.Decoder, worker *gardencorev1alpha1.ProviderConfig, fldPath *field.Path) (*aws.WorkerConfig, error) {
...
func decodeControlPlaneConfig(decoder runtime.Decoder, cp *gardencorev1alpha1.ProviderConfig, fldPath *field.Path) (*aws.ControlPlaneConfig, error) {
...
func decodeInfrastructureConfig(decoder runtime.Decoder, infra *gardencorev1alpha1.ProviderConfig, fldPath *field.Path) (*aws.InfrastructureConfig, error) {
