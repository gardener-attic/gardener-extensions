	...
	cmd := &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			reconcileOpts.Completed().Apply(
				&awsinfrastructure.DefaultAddOptions.IgnoreOperationAnnotation,
				&awscontrolplane.DefaultAddOptions.IgnoreOperationAnnotation,
				&awsworker.DefaultAddOptions.IgnoreOperationAnnotation,
			)
