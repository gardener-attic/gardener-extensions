...
// +k8s:conversion-gen=github.com/gardener/gardener-extensions/controllers/extension-certificate-service/pkg/apis/config
// +k8s:defaulter-gen=TypeMeta
// +groupName=certificateservice.extensions.gardener.cloud
