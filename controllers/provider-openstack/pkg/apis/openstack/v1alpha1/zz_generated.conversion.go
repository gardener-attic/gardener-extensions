...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OpenStackRouter)(nil), (*openstack.OpenStackRouter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OpenStackRouter_To_openstack_OpenStackRouter(a.(*OpenStackRouter), b.(*openstack.OpenStackRouter), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.OpenStackRouter)(nil), (*OpenStackRouter)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_OpenStackRouter_To_v1alpha1_OpenStackRouter(a.(*openstack.OpenStackRouter), b.(*OpenStackRouter), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_Networks_To_openstack_Networks(in *Networks, out *openstack.Networks, s conversion.Scope) error {
	out.Router = (*openstack.OpenStackRouter)(unsafe.Pointer(in.Router))
...
func autoConvert_v1alpha1_OpenStackRouter_To_openstack_OpenStackRouter(in *OpenStackRouter, out *openstack.OpenStackRouter, s conversion.Scope) error {
	out.ID = in.ID
	return nil
}

// Convert_v1alpha1_OpenStackRouter_To_openstack_OpenStackRouter is an autogenerated conversion function.
func Convert_v1alpha1_OpenStackRouter_To_openstack_OpenStackRouter(in *OpenStackRouter, out *openstack.OpenStackRouter, s conversion.Scope) error {
	return autoConvert_v1alpha1_OpenStackRouter_To_openstack_OpenStackRouter(in, out, s)
}

func autoConvert_openstack_OpenStackRouter_To_v1alpha1_OpenStackRouter(in *openstack.OpenStackRouter, out *OpenStackRouter, s conversion.Scope) error {
	out.ID = in.ID
	return nil
}

// Convert_openstack_OpenStackRouter_To_v1alpha1_OpenStackRouter is an autogenerated conversion function.
func Convert_openstack_OpenStackRouter_To_v1alpha1_OpenStackRouter(in *openstack.OpenStackRouter, out *OpenStackRouter, s conversion.Scope) error {
	return autoConvert_openstack_OpenStackRouter_To_v1alpha1_OpenStackRouter(in, out, s)
}
