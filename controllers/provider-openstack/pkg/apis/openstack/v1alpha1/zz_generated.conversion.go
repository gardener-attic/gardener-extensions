...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProviderProfileConfig)(nil), (*openstack.ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProviderProfileConfig_To_openstack_ProviderProfileConfig(a.(*ProviderProfileConfig), b.(*openstack.ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.ProviderProfileConfig)(nil), (*ProviderProfileConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(a.(*openstack.ProviderProfileConfig), b.(*ProviderProfileConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ProviderProfileConfig_To_openstack_ProviderProfileConfig(in *ProviderProfileConfig, out *openstack.ProviderProfileConfig, s conversion.Scope) error {
...
// Convert_v1alpha1_ProviderProfileConfig_To_openstack_ProviderProfileConfig is an autogenerated conversion function.
func Convert_v1alpha1_ProviderProfileConfig_To_openstack_ProviderProfileConfig(in *ProviderProfileConfig, out *openstack.ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProviderProfileConfig_To_openstack_ProviderProfileConfig(in, out, s)
}

func autoConvert_openstack_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *openstack.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
...
// Convert_openstack_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig is an autogenerated conversion function.
func Convert_openstack_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in *openstack.ProviderProfileConfig, out *ProviderProfileConfig, s conversion.Scope) error {
	return autoConvert_openstack_ProviderProfileConfig_To_v1alpha1_ProviderProfileConfig(in, out, s)
}
