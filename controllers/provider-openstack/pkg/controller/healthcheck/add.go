...
func RegisterHealthChecks(mgr manager.Manager, opts healthcheck.DefaultAddArgs) error {
	...
	if err := healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			general.CheckSeedDeployment(openstack.CloudControllerManagerName):                            string(gardencorev1beta1.ShootControlPlaneHealthy),
	...
	return healthcheck.DefaultRegistration(
		...
		map[healthcheck.HealthCheck]string{
			...
			general.CheckSeedDeployment(openstack.MachineControllerManagerName):      string(gardencorev1beta1.ShootControlPlaneHealthy),
