...
// Source: github.com/gardener/gardener-extensions/pkg/controller/controlplane/genericactuator (interfaces: ValuesProvider,ShootClientsFactory)
...
type MockShootClientsFactory struct {
	ctrl     *gomock.Controller
	recorder *MockShootClientsFactoryMockRecorder
}
...
func NewMockShootClientsFactory(ctrl *gomock.Controller) *MockShootClientsFactory {
	mock := &MockShootClientsFactory{ctrl: ctrl}
	mock.recorder = &MockShootClientsFactoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockShootClientsFactory) EXPECT() *MockShootClientsFactoryMockRecorder {
	return m.recorder
}
...
func (m *MockShootClientsFactory) NewClientsForShoot(arg0 context.Context, arg1 client.Client, arg2 string, arg3 client.Options) (util.ShootClients, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewClientsForShoot", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(util.ShootClients)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockShootClientsFactoryMockRecorder) NewClientsForShoot(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewClientsForShoot", reflect.TypeOf((*MockShootClientsFactory)(nil).NewClientsForShoot), arg0, arg1, arg2, arg3)
}
