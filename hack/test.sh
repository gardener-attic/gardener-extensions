...
SKIP_NETWORKPOLICY_TESTS=$(echo controllers/provider-{alicloud,aws,openstack}/test/e2e/networkpolicies | sed 's/ /,/g')

#skip integration tests
SKIP_INTEGRATION_TESTS+=$(echo controllers/provider-{alicloud,aws,openstack}/test/integration | sed 's/ /,/g')
