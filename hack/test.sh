...
SKIP_NETWORKPOLICY_TESTS=$(echo controllers/provider-{alicloud,aws}/test/e2e/networkpolicies | sed 's/ /,/g')

#skip integration tests
SKIP_INTEGRATION_TESTS+=$(echo controllers/provider-{alicloud,aws}/test/integration | sed 's/ /,/g')
